  ...
  return (
    <div className="flex flex-col h-[80vh] mt-30">
      ...
      <div className="flex flex-col mx-14.25 mb-8">
        ...
        <p className="mt-10 mb-6 font-family-souvenir text-center text-luisa-pink font-bold text-3xl mx-auto -tracking-wide uppercase ">
          spreading <br />{' '}
              ...
              {heroOverlayGif ? (
                <>
                  ...
                  <div className="flex flex-col mt-1 gap-1 text-luisa-gray/50 uppercase text-xs">
                    ...
                    {heroOverlayGif.place && <p className="text-right">{heroOverlayGif.place}</p>}
                  </div>
                </>
              ) : (
